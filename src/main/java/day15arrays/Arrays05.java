...
public class Arrays05 {
    public static void main(String[] args) {
        ...
        //Example 1:String Array elemanlarini uxzunluklarina gore kucukten buyuge siralayiniz
        ...
        Arrays.sort(brr,Comparator.comparingInt(String::length).reversed()); //REVERSED - TERSTEN YAPMAK
