...
public class Student {
       ...
       // StudentID okul yonetimindeki insanlar tarafindan bilinebilir, o yuzden default
       String stdId = "TH2023HU12001";
       //account number ben,esim ve cocuklarim tarafindan bilinebilir, oyuzden protected
       protected int accountNum = 76512345;
       //hesabimdaki para miktari sadece benim tarafimdan bilinmelidir, o yuzden private
       private int balance = 123000;//


       /*

              1)Access modifier lar genisten dara; public > protected > default > private
